...
from './Blog/Blog'
export { default as SingleBlog }
from './Blog/SingleBlog/SingleBlog'
export { default as Education }
from './Education/Education'
export { default as Experience }
...
export { default as SingleProject }
from './Projects/SingleProject/SingleProject'
export { default as SingleService }
from './Services/SingleService/SingleService'
export { default as Achievement }
from './Achievement/Achievement'

export { default as BackToTop }
from './BackToTop/BackToTop'